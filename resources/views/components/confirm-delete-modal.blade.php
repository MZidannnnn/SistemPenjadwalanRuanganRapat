...
<div id="confirmDeleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-2xl shadow-2xl p-8 m-4 max-w-sm w-full text-center">
        ...
        <p class="text-gray-500 mt-2 mb-6">Are you sure you want to delete this?</p>
        ...
        <form id="deleteForm" action="" method="POST">
            ...
            <div class="flex justify-center space-x-4">
                <button type="button" onclick="closeConfirmDeleteModal()" class="bg-white text-gray-800 font-semibold px-6 py-2 rounded-lg border border-gray-300 hover:bg-gray-100 transition">
                    Cancel
                </button>
...
<script>
     ...
     * @param {string} actionUrl - URL tujuan untuk form penghapusan.
     */
    function openConfirmDeleteModal(actionUrl) {
        // Atur action form sesuai dengan URL yang dikirim
