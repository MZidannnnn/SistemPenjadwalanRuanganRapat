...
@section('content')
    ...
    <div id="addUserModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50" onclick="closeModal()">
    ...
    <div id="detailUserModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50" onclick="closeDetailModal()">
        <div class="bg-white rounded-2xl shadow-2xl p-6 md:p-8 m-4 max-w-lg w-full" onclick="event.stopPropagation()">
            <div class="flex justify-between items-center mb-6">
            ...
            <form id="editForm" action="" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="jabatan" class="block text-sm font-medium text-gray-700 mb-1">Jabatan</label>
                        <input type="text" name="jabatan" id="detail_jabatan"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
...
@push('scripts')
    <script>
        ...
        function openDetailModal(user) {
            ...
            document.getElementById('detail_jabatan').value = user.jabatan;
